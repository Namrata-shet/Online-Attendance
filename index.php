...
<body>
	<table width="800" border="1" align="center">
		<tr>
			<td bordercolor="#330033" bgcolor="#CCCCFF"><h1 align="center"><strong>
				<span class="style1">Attendance System</span></strong></h1></td>
                </tr>
                <tr>
               		...
               		<form action="insertmember.php" method="post">
               			<table width="400" border="2" align="center" bordercolor="#9966FF" bgcolor="#C7B6B1">
               				...
               				<tr>
               					...
               					<td width="222"><span class="style6"><input type="text" name="name"/></span></td></tr>
               					<tr>
               					...
               					<tr>
               						<td colspan="2"><div align="center"><input type="submit" value="Add Member" name="btnsubmit"/>
               						&nbsp;&nbsp;
